...
// --------------------------------------------------------------------------------------------------------------------
namespace Deveknife.Blades.BladeModuleTemplate.Installers
{
    using Deveknife.Api;
    ...
    public class BladesInstaller : IWindsorInstaller
    {
        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            // container.Register(Types.FromAssemblyNamed("Deveknife.Blades.BladeModuleTemplate").BasedOn(typeof(IBladeTool)).WithServiceAllInterfaces().LifestyleTransient());
