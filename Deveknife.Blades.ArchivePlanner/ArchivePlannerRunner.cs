// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchivePlannerRunner.cs" company="EvePanix">
...
namespace Deveknife.Blades.ArchivePlanner
{
    ...
    /// </summary>
    public class ArchivePlannerRunner : BladeRunner, IBlade
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchivePlannerRunner"/> class.
        /// </summary>
        /// <param name="host">The host.</param>
        /// <param name="ui">The UI.</param>
        public ArchivePlannerRunner(IHost host, ArchivePlannerUI ui)
            : base(host, ui)
        {
            ui.Blade = this;
        }
