// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchivePlannerUI.cs" company="EvePanix">
...
namespace Deveknife.Blades.ArchivePlanner
{
    ...
    using Deveknife.Api;
    using Deveknife.Blades.ArchivePlanner.Util;
    using Deveknife.Blades.Utils.Filters;

    using Castle.Core.Logging;

    /// <summary>
    /// The user-interface of the File Archive planner tool.
    /// </summary>
    public partial class ArchivePlannerUI : UserControl, IBladeUI
    {
        /// <summary>
        ///     The fixed filter
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchivePlannerUI"/> class.
        /// </summary>
        /// <param name="host">
        /// The host.
        /// </param>
        ...
        /// </param>
        public ArchivePlannerUI(IHost host, ILogger logger, IBladeToolFactory bladeToolFactory)
            : this()
        {
            this.host = Guard.NotNull(() => host, host);
            Guard.NotNull(() => logger, logger);
            this.Logger = logger.CreateChildLogger("ArchivePlannerLogger");
            this.BladeToolFactory = Guard.NotNull(() => bladeToolFactory, bladeToolFactory);

            this.treeListExplorer1.Logger = this.Logger;
            this.treeListExplorer1.ProgressChanged += this.TreeListExplorer1ProgressChanged;
            ...
            // new ArchivePlannerUiGridMenu<EITFormatDisplay>(this.gridView1), 
        ...
        /// <summary>
        /// Handles the ProgressChanged event of the treeListExplorer1 control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.ComponentModel.ProgressChangedEventArgs"/> instance containing the event data.</param>
        /// <exception cref="System.NotImplementedException"></exception>
        void TreeListExplorer1ProgressChanged(object sender, System.ComponentModel.ProgressChangedEventArgs e)
        {
            this.pbProgress.IvReq(
                () =>
                {
                    int percent = e.ProgressPercentage;
                    this.pbProgress.EditValue = percent;
                });
        }

        /// <summary>
        ///     Prevents a default instance of the <see cref="ArchivePlannerUI" /> class from being created.
        /// </summary>
        private ArchivePlannerUI()
        {
        ...
        public string BladeName
        {
            get
            {
                return "ArchivePlanner Module <Rename Me>";
            }
        }
        ...
        /// </summary>
        /// <exception cref="Deveknife.Blades.ArchivePlanner.ArchivePlannerException">One to rule them all ... Test Exception.</exception>
        public static void ThrowSomething()
        {
            throw new ArchivePlannerException("One to rule them all ... Test Exception.");
        }
        ...
        /// <summary>
        /// Handles the Load event of the ArchivePlannerUI control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void ArchivePlannerUILoad([NotNull] object sender, [NotNull] EventArgs e)
        {
        ...
        /// The blade tool factory.
        /// </param>
        private void InitGridMenuRunActions(ArchivePlannerUiGridMenu<Dummy> gmenu, IBladeToolFactory bladeToolFactory)
        {
        ...
        {
            this.tbArchivePlannerLog.Clear();
        }
        ...
        /// The <see cref="EventArgs"/> instance containing the event data.
        /// </param>
        private void TbArchivePlannerLogTextChanged(object sender, EventArgs e)
        {
            this.tbArchivePlannerLog.SelectionStart = this.tbArchivePlannerLog.Text.Length;
            this.tbArchivePlannerLog.ScrollToCaret();
            this.tbArchivePlannerLog.SelectionLength = 0;
        }
