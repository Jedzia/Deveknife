...
// --------------------------------------------------------------------------------------------------------------------
namespace Deveknife.Blades.ArchivePlanner.Installers
{
    using Deveknife.Api;
    ...
    public class BladesInstaller : IWindsorInstaller
    {
        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            // container.Register(Types.FromAssemblyNamed("Deveknife.Blades.ArchivePlanner").BasedOn(typeof(IBladeTool)).WithServiceAllInterfaces().LifestyleTransient());
