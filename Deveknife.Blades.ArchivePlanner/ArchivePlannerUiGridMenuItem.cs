// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchivePlannerUiGridMenuItem.cs" company="EvePanix">
...
namespace Deveknife.Blades.ArchivePlanner
{
    ...
    /// <summary>
    /// A menu item storage class for the <see cref="ArchivePlannerUiGridMenu{T}" /> class.
    /// </summary>
    /// <typeparam name="T">Underlying type of the Gridview's data to store.</typeparam>
    internal class ArchivePlannerUiGridMenuItem<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchivePlannerUiGridMenuItem{T}" /> class.
        /// </summary>
        /// <param name="caption">The caption.</param>
        /// <param name="action">The action.</param>
        /// <param name="image">The image.</param>
        public ArchivePlannerUiGridMenuItem(
            string caption,
