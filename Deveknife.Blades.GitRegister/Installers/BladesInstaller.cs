...
// --------------------------------------------------------------------------------------------------------------------
namespace Deveknife.Blades.GitRegister.Installers
{
    using Deveknife.Api;
    ...
    public class BladesInstaller : IWindsorInstaller
    {
        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            // container.Register(Types.FromAssemblyNamed("Deveknife.Blades.GitRegister").BasedOn(typeof(IBladeTool)).WithServiceAllInterfaces().LifestyleTransient());
