// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VideoOverviewUiGridMenuItem.cs" company="EvePanix">
...
namespace Deveknife.Blades.Overview
{
    ...
    /// <summary>
    /// A menu item storage class for the <see cref="VideoOverviewUiGridMenu{T}" /> class.
    /// </summary>
    /// <typeparam name="T">Underlying type of the Gridview's data to store.</typeparam>
    internal class VideoOverviewUiGridMenuItem<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoOverviewUiGridMenuItem{T}" /> class.
        /// </summary>
        /// <param name="caption">The caption.</param>
        /// <param name="action">The action.</param>
        /// <param name="image">The image.</param>
        public VideoOverviewUiGridMenuItem(
            string caption, 
