// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileManagerUiGridMenu.cs" company="EvePanix">
...
namespace Deveknife.Blades.FileManager
{
    ...
    /// <summary>
    /// Represents the Context-Menu for the FileManagerUi's gridview.
    /// </summary>
    /// <typeparam name="T">Underlying type of the Gridview's data.</typeparam>
    internal class FileManagerUiGridMenu<T>
        where T : class
    {
        private readonly Dictionary<string, FileManagerUiGridMenuItem<T>> actions;

        /// <summary>
        /// Initializes a new instance of the <see cref="FileManagerUiGridMenu{T}" /> class.
        /// </summary>
        /// <param name="gridview">The bound gridview.</param>
        public FileManagerUiGridMenu(GridView gridview)
        {
            this.actions = new Dictionary<string, FileManagerUiGridMenuItem<T>>();
        ...
        {
            this.actions.Add(menuCaption, new FileManagerUiGridMenuItem<T>(menuCaption, action, image));
        }
        ...
        private void OnHandleGridMenuItemClick(object sender, EventArgs e)
        {
            ...
            FileManagerUiGridMenuItem<T> action;
