...
//  <date>22.10.2016 09:46</date>
// --------------------------------------------------------------------------------------------------------------------
namespace Deveknife.Blades.FileManager.Installers
{
    using Deveknife.Api;
    ...
    public class BladesInstaller : IWindsorInstaller
    {
        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            // container.Register(Types.FromAssemblyNamed("Deveknife.Blades.FileManager").BasedOn(typeof(IBladeTool)).WithServiceAllInterfaces().LifestyleTransient());
