// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileManagerUiGridMenuItem.cs" company="EvePanix">
...
namespace Deveknife.Blades.FileManager
{
    ...
    /// <summary>
    /// A menu item storage class for the <see cref="FileManagerUiGridMenu{T}" /> class.
    /// </summary>
    /// <typeparam name="T">Underlying type of the Gridview's data to store.</typeparam>
    internal class FileManagerUiGridMenuItem<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileManagerUiGridMenuItem{T}" /> class.
        /// </summary>
        /// <param name="caption">The caption.</param>
        /// <param name="action">The action.</param>
        /// <param name="image">The image.</param>
        public FileManagerUiGridMenuItem(
            string caption, 
