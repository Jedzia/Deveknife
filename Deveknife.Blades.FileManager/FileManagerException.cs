// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileManagerException.cs" company="EvePanix">
...
namespace Deveknife.Blades.FileManager
{
    ...
    public class FileManagerException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileManagerException" /> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileManagerException" /> class with serialized data.
        /// </summary>
