// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileMoveToolUiGridMenuItem.cs" company="EvePanix">
...
namespace Deveknife.Blades.FileMoveTool
{
    ...
    /// <summary>
    /// A menu item storage class for the <see cref="FileMoveToolUiGridMenu{T}" /> class.
    /// </summary>
    /// <typeparam name="T">Underlying type of the Gridview's data to store.</typeparam>
    internal class FileMoveToolUiGridMenuItem<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileMoveToolUiGridMenuItem{T}" /> class.
        /// </summary>
        /// <param name="caption">The caption.</param>
        /// <param name="action">The action.</param>
        /// <param name="image">The image.</param>
        public FileMoveToolUiGridMenuItem(
            string caption,
