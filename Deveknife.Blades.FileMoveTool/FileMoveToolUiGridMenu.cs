// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileMoveToolUiGridMenu.cs" company="EvePanix">
...
namespace Deveknife.Blades.FileMoveTool
{
    ...
    /// <summary>
    /// Represents the Context-Menu for the FileMoveToolUi´s gridview.
    /// </summary>
    /// <typeparam name="T">Underlying type of the Gridview´s data.</typeparam>
    internal class FileMoveToolUiGridMenu<T>
        where T : class
    {
        private readonly Dictionary<string, FileMoveToolUiGridMenuItem<T>> actions;

        /// <summary>
        /// Initializes a new instance of the <see cref="FileMoveToolUiGridMenu{T}" /> class.
        /// </summary>
        /// <param name="gridview">The bound gridview.</param>
        public FileMoveToolUiGridMenu(GridView gridview)
        {
            this.actions = new Dictionary<string, FileMoveToolUiGridMenuItem<T>>();
        ...
        {
            this.actions.Add(menuCaption, new FileMoveToolUiGridMenuItem<T>(menuCaption, action, image));
        }
        ...
        private void OnHandleGridMenuItemClick(object sender, EventArgs e)
        {
            ...
            FileMoveToolUiGridMenuItem<T> action;
