// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileOperationAPIWrapper.cs" company="EvePanix">
...
namespace Deveknife
{
    ...
    public class FileOperationAPIWrapper
    {
        ...
        {
            return FileOperationAPIWrapper.deleteFile(
                path,
        ...
        {
            return FileOperationAPIWrapper.Send(
                path,
        ...
        public static bool Send(string path, FileOperationFlags flags)
        {
            try
            {
                ...
                FileOperationAPIWrapper.SHFileOperation(ref fs);
                return true;
            }
            catch (Exception)
            {
        ...
        {
            return FileOperationAPIWrapper.Send(path, FileOperationFlags.FOF_NOCONFIRMATION | FileOperationFlags.FOF_WANTNUKEWARNING);
        }
